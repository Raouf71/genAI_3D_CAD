...
async def main():
    ...
    config = RAGAnythingConfig(
        ...
        context_window=1,                     # include the hit page + 1 neighbor page (covers 2 pages well)
    ...
    await rag.process_document_complete(
        file_path="C:/Users/grabe_stud/llm_cad_projekt/RAG/llm_3d_cad/RAG-Anything/external_knowledge_base/same_gear_different_module.pdf",
    ...
    # for z2 in range(12, 20):    

    #     # Without specifiying module
    #     query = (
    ...
    # output_file = "table_lookups_diff_m.txt"
