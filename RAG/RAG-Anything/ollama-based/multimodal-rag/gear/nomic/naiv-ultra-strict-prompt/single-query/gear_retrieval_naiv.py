...
async def main():
    config = RAGAnythingConfig(
        ...
        context_window=5,               # just that page
        ...
        **kwargs,
        ...
        if system_prompt and "---Context---" in system_prompt:
            ...
            4) Search ONLY within "table.rows" of the TABLE_AS_JSON blocks:
                - Find the row where row[column_name] EXACTLY equals the requested value, 
            ...
            5) If you do NOT find any matching row in ANY TABLE_AS_JSON block:
    ...
    text_result = await rag.aquery(
        "From the table with dimensions for polyacetal spur gears, please extract the full row for Z2=13 teeth",
        vlm_enhanced=False,
        enable_rerank=False,
