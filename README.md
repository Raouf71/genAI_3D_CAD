Purpose
---
This branch is dedicated to testing/implementing RAG techniques in order to retrieve key design features from pdf documents of German standards (like Tabellenbuch Metall).
...
lezemna taswira lel system lkollou wel data flow
model yasna3 .json
w yasna3 fichier .graphml
