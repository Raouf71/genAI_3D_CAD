...
async def main():
    ...
    await rag.process_document_complete(
        file_path="C:/Users/grabe_stud/llm_cad_projekt/RAG/llm_3d_cad/RAG-Anything/external_knowledge_base/2_tabs_1_page.pdf",
        output_dir="./output_ollama_2tabs1page",
        parse_method="auto",
    ...
    text_result = await rag.aquery(
        query = (
            "From the table with dimensions for bevel gears, "
            f"please extract the full row for Z=15 and M=1,0"
        ),
        vlm_enhanced=False,
        enable_rerank=False,
        mode="naive",
